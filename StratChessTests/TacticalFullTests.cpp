...
static constexpr TacticalCase kSlowCases[] = {
    // — Mate-in-1 (back rank) ————————————————————————————————————————————————
    {"M1: rook e3 back rank (Re8#)", "6k1/5ppp/8/8/8/4R3/5PPP/6K1 w - - 0 1", e3, e8, 6},
    {"M1: rook b1 back rank (Rb8#)", "6k1/5ppp/8/8/8/8/5PPP/1R4K1 w - - 0 1", b1, b8, 6},

    // — Winning captures (piece gives cover) ——————————————————————————————————
    {"capture: Qxa8 (rook+queen battery)", "r5k1/5ppp/8/3Q4/8/8/5PPP/4R1K1 w - - 0 1", d5, a8, 6},
    {"capture: Qxa8 (queen + pawns)", "r3k3/5ppp/8/3Q4/8/8/5PPP/6K1 w - - 0 1", d5, a8, 6},
    {"capture: Qxb8 (pawn cover)", "1r4k1/5ppp/8/8/8/1Q6/5PPP/6K1 w - - 0 1", b3, b8, 6},

    // — Winning captures (hanging pieces) ————————————————————————————————————
    {"capture: Bxa8 (diagonal)", "r3k3/8/8/3B4/8/8/8/4K3 w - - 0 1", d5, a8, 6},
    {"capture: Nxa8", "r3k3/8/1N6/8/8/8/8/4K3 w - - 0 1", b6, a8, 6},
    {"capture: Rxb8", "1r2k3/8/8/8/8/8/8/1R2K3 w - - 0 1", b1, b8, 6},
    {"capture: Qxd8 (wins queen)", "3q1k2/8/8/8/8/8/8/3QK3 w - - 0 1", d1, d8, 6},
    {"capture: Rxd4", "4k3/8/8/8/3r4/8/3R4/4K3 w - - 0 1", d2, d4, 6},
    {"capture: Rxd8", "3r2k1/8/8/8/8/8/8/3RK3 w - - 0 1", d1, d8, 6},
    {"capture: Qxa8 (queen + 2 pawns)", "r5k1/6pp/8/8/8/8/6PP/Q5K1 w - - 0 1", a1, a8, 6},
    {"capture: Qxb8 (corner rook)", "1r4k1/8/8/8/8/8/8/1Q4K1 w - - 0 1", b1, b8, 6},
    {"capture: Rxc8", "2r3k1/8/8/8/8/8/8/2R3K1 w - - 0 1", c1, c8, 6},
    {"capture: Qxa7 (rank 7 rook)", "4k3/r7/8/8/8/8/8/Q3K3 w - - 0 1", a1, a7, 6},
    {"capture: Bxa8 (long diagonal)", "r3k3/8/8/8/8/5B2/8/4K3 w - - 0 1", f3, a8, 6},
    {"capture: Rxa8", "r3k3/8/8/8/8/8/8/R3K3 w - - 0 1", a1, a8, 6},
    {"capture: Qxd4 (bishop)", "4k3/8/8/8/3b4/8/8/3QK3 w - - 0 1", d1, d4, 6},
    {"capture: Qxc2 (bishop)", "4k3/8/8/8/8/8/2b5/3QK3 w - - 0 1", d1, c2, 6},
    {"capture: Qxc5 (knight)", "4k3/8/8/2n5/8/8/8/2QK4 w - - 0 1", c1, c5, 6},
    {"capture: Qxd3 (knight)", "4k3/8/8/8/8/3n4/8/3QK3 w - - 0 1", d1, d3, 6},
    {"capture: Rxb5 (bishop)", "4k3/8/8/1b6/8/8/8/1R2K3 w - - 0 1", b1, b5, 6},
    {"capture: Qxe5 (rook)", "4k3/8/8/4r3/4Q3/8/8/4K3 w - - 0 1", e4, e5, 6},
    {"capture: Qxa8 (direct)", "r3k3/8/8/8/8/8/8/Q3K3 w - - 0 1", a1, a8, 6},
    {"capture: Rxa3", "4k3/8/8/8/8/r7/8/R3K3 w - - 0 1", a1, a3, 6},
};
