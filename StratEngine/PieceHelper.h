...
static inline constexpr bool IsOfType(ePiece piece, ePieceType type) noexcept { return ((piece >> 1) == (type >> 1)); }
...
static inline constexpr ePieceType AsPieceType(ePiece piece) noexcept { return static_cast<ePieceType>(piece >> 1); }
