...

{
  public:
	...
	// sorted descending by score. Priority: hash move -> SEE-winning captures and all
	// promotions -> killer0 -> killer1 -> SEE-equal captures -> history (quiet) ->
	// SEE-losing captures, with generation order as the final tie-break.
