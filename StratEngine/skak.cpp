...
//	g_cPieceNames[ePiece::WHITE_PAWN] = 'P';
//	g_cPieceNames[ePiece::WHITE_KNIGHT] = 'N';
//	g_cPieceNames[ePiece::WHITE_BISHOP] = 'B';
//	g_cPieceNames[ePiece::WHITE_ROOK] = 'R';
//	g_cPieceNames[ePiece::WHITE_QUEEN] = 'Q';
//	g_cPieceNames[ePiece::WHITE_KING] = 'K';
//
//	g_cPieceNames[ePiece::BLACK_PAWN] = 'p';
//	g_cPieceNames[ePiece::BLACK_KNIGHT] = 'n';
//	g_cPieceNames[ePiece::BLACK_BISHOP] = 'b';
//	g_cPieceNames[ePiece::BLACK_ROOK] = 'r';
//	g_cPieceNames[ePiece::BLACK_QUEEN] = 'q';
//	g_cPieceNames[ePiece::BLACK_KING] = 'k';
//
//	g_cPieceNames[ALL_PIECETYPES] = '.';
//
//	// Setup verbose piece names
//	g_cPieceNamesVerbose[ePiece::WHITE_PAWN] = "White pawn";
//	g_cPieceNamesVerbose[ePiece::WHITE_KNIGHT] = "White knight";
//	g_cPieceNamesVerbose[ePiece::WHITE_BISHOP] = "White bishop";
//	g_cPieceNamesVerbose[ePiece::WHITE_ROOK] = "White rook";
//	g_cPieceNamesVerbose[ePiece::WHITE_QUEEN] = "White queen";
//	g_cPieceNamesVerbose[ePiece::WHITE_KING] = "White king";
//
//	g_cPieceNamesVerbose[ePiece::BLACK_PAWN] = "Black pawn";
//	g_cPieceNamesVerbose[ePiece::BLACK_KNIGHT] = "Black knight";
//	g_cPieceNamesVerbose[ePiece::BLACK_BISHOP] = "Black bishop";
//	g_cPieceNamesVerbose[ePiece::BLACK_ROOK] = "Black rook";
//	g_cPieceNamesVerbose[ePiece::BLACK_QUEEN] = "Black queen";
//	g_cPieceNamesVerbose[ePiece::BLACK_KING] = "Black king";
//
//	unsigned int iFile = 0;
//	unsigned int iRank = 0;
//	int j = 0;
//
//	// Setup masks for bitboard-calculations
...
//		g_bbMaskRotated90[g_iRotateR90[i]] = g_bbMask[i];
//		g_bbMaskRotated45R[g_iRotateR45[i]] = g_bbMask[i];
//		g_bbMaskRotated45L[g_iRotateL45[i]] = g_bbMask[i];
//
//		// Diagonale masker for loebere og dronning
//		g_bbDiagonalMask_a1h8[i] = (1UI64 << g_iDiagonalLength_a1h8[i]) - 1;
//		g_bbDiagonalMask_a8h1[i] = (1UI64 << g_iDiagonalLength_a8h1[i]) - 1;
//
//		// Maskers for felter over et vist felt
//		g_bbFileUpMask[i] = g_bbFileDownMask[i] = 0;
//		for (j = i - 8; j >= 0; j -= 8)
//			g_bbFileUpMask[i] += (UNIT << j);
//		for (j = i + 8; j < 64; j += 8)
//			g_bbFileDownMask[i] += (UNIT << j);
//	}
//
//
//	/*
...
//
//		spdlog::default_logger()->info("Logging subsystem ready - from skak.cpp");
//	}
//
...
//	{
//		spdlog::default_logger()->critical(exc);
