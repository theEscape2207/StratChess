...
- **An SPRT against the anchor tests the sum.** H1 means "`main` + this change beats the anchor by
  ...
  licenses no claim about one addend. See the 2026-07-29 `candidate-b327d47` row, where H1 was
