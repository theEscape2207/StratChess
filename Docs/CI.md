...
| `agent-docs` | `Test-AgentDocs.ps1`: skill and agent frontmatter, Codex adapter parity and routes, and cited paths and identifiers that no longer resolve. Not in PrePR |
